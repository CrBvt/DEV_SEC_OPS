...
def get_highcharts_basic_area(container):
    as_dict = {
        'chart': {
            'type': 'area'
        },
        ...
        'series': [{
            ...
            'name': 'USSR/Russia',
            'data': [EnforcedNull, EnforcedNull, EnforcedNull, EnforcedNull, EnforcedNull, EnforcedNull, EnforcedNull,
                     EnforcedNull, EnforcedNull,
